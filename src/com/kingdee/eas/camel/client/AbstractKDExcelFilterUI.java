 ...
 * output class name
 */
public abstract class AbstractKDExcelFilterUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractKDExcelFilterUI.class);
     ...
     */
    public AbstractKDExcelFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractKDExcelFilterUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 410, 240));
        this.setLayout(null);
        kDLabel1.setBounds(new Rectangle(11, 8, 100, 19));
        this.add(kDLabel1, null);
        kDPanel1.setBounds(new Rectangle(11, 36, 387, 171));
        this.add(kDPanel1, null);
        btnYes.setBounds(new Rectangle(229, 213, 73, 21));
        this.add(btnYes, null);
        btnNO.setBounds(new Rectangle(323, 213, 73, 21));
        this.add(btnNO, null);
        //kDPanel1
        kDPanel1.setLayout(null);        kDComboBox1.setBounds(new Rectangle(16, 29, 170, 19));
        kDPanel1.add(kDComboBox1, null);
        kDComboBox2.setBounds(new Rectangle(196, 29, 170, 19));
        kDPanel1.add(kDComboBox2, null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.camel.app.KDExcelFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.camel.client", "KDExcelFilterUI");
    }
